...
public class IndexAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Ket: Untuk Menambah Daftar Barang silahkan ClearField dahulu");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
            tambahDataBarang(nama, jenis, jumlah);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        else
        {
             try {
                 ...
                 Logger.getLogger(IndexAdmin.class.getName()).log(Level.SEVERE, null, ex);
             }
